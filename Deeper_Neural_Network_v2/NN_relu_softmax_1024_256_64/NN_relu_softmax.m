...
hidden_layer_1_size = 1024;  % 1024 hidden units
hidden_layer_2_size = 256;   % 256 hidden units
hidden_layer_3_size = 64;    % 64 hidden units
...
Theta4 = reshape(nn_params(1 + hidden_layer_1_size * (input_layer_size + 1) + ...
                 hidden_layer_2_size * (hidden_layer_1_size + 1) + ...
                 hidden_layer_3_size * (hidden_layer_2_size + 1):end), ...
                 num_labels, (hidden_layer_3_size + 1));

% Save Model Weights
%save('NN_relu_softmax_weights.mat', 'Theta1', 'Theta2', 'Theta3', 'Theta4');
...
y_train_pred = predict(Theta1, Theta2, Theta3, Theta4, X_train);
fprintf('\nTraining Set Accuracy: %.2f %%\n', mean(double(y_train_pred == y_train)) * 100);

y_test_pred = predict(Theta1, Theta2, Theta3, Theta4, X_test);
