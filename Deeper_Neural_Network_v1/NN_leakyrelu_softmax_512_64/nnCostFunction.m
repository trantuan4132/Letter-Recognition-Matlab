...
a1 = [ones(m, 1) X];
z2 = a1 * Theta1';
a2 = leakyrelu(z2, 0.01, false);
a2 = [ones(m, 1) a2];
z3 = a2 * Theta2';
a3 = leakyrelu(z3, 0.01, false);
a3 = [ones(m, 1) a3];
...
if backward == true
    delta4 = a4 - y_n;
    delta3 = (delta4 * Theta3) .* leakyrelu([ones(m, 1) z3], 0.01, true);
    delta3 = delta3(:, 2:end);
    delta2 = (delta3 * Theta2) .* leakyrelu([ones(m, 1) z2], 0.01, true);
    delta2 = delta2(:, 2:end);
